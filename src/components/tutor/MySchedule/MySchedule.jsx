...
import s from './MySchedule.module.scss'
    ...
    <div className="bg-white p-4">
      <div>
        ...
        <div className={s.buttons}>
          ...
          <BigOrangeBtn classname={s.secondaryBtn}
                        onClick={() => setShowBlock(1)}>{t('set_your_schedule')}</BigOrangeBtn>

          <BigOrangeBtn classname={s.secondaryBtn}
                        onClick={() => setShowBlock(2)}>{t('set_your_holidays')}</BigOrangeBtn>
        </div>

        <div className={s.whatToDoText}>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aperiam autem, dolorum exercitationem in, molestiae molestias mollitia </div>
                ...
                <Row>
                  <Col md={3}>
                    <Form.Group className="mb-3" controlId="formBasicFirstName">
                      ...
                      <TimePicker format={24} start="00:00" end="23:00" step={60} value={refSundayFrom}
                                  onChange={val => setRefSundayFrom(val)}/>
                      <TimePicker format={24} start="00:00" end="23:00" step={60} value={refSundayTo}
                                  onChange={val => setRefSundayTo(val)}/>
                    </Form.Group>
                  </Col>
                  <Col md={3}>
                    <Form.Group className="mb-3" controlId="formBasicFirstName">
                      <Form.Label>{t('monday')}</Form.Label>
                      <TimePicker format={24} start="00:00" end="23:00" step={60} value={refMondayFrom}
                                  onChange={val => setRefMondayFrom(val)}/>
                      <TimePicker format={24} start="00:00" end="23:00" step={60} value={refMondayTo}
                                  onChange={val => setRefMondayTo(val)}/>
                    </Form.Group>
                  </Col>
                  <Col md={3}>
                    <Form.Group className="mb-3" controlId="formBasicFirstName">
                      <Form.Label>{t('tuesday')}</Form.Label>
                      <TimePicker format={24} start="00:00" end="23:00" step={60} value={refTuesdayFrom}
                                  onChange={val => setRefTuesdayFrom(val)}/>
                      <TimePicker format={24} start="00:00" end="23:00" step={60} value={refTuesdayTo}
                                  onChange={val => setRefTuesdayTo(val)}/>
                    </Form.Group>
                  </Col>
                  <Col md={3}>
                    <Form.Group className="mb-3" controlId="formBasicFirstName">
                      <Form.Label>{t('wednesday')}</Form.Label>
                      <TimePicker format={24} start="00:00" end="23:00" step={60} value={refWednesdayFrom}
                                  onChange={val => setRefWednesdayFrom(val)}/>
                      <TimePicker format={24} start="00:00" end="23:00" step={60} value={refWednesdayTo}
                                  onChange={val => setRefWednesdayTo(val)}/>
                    </Form.Group>
                  </Col>
                  <Col md={3}>
                    <Form.Group className="mb-3" controlId="formBasicFirstName">
                      <Form.Label>{t('thursday')}</Form.Label>
                      <TimePicker format={24} start="00:00" end="23:00" step={60} value={refThursdayFrom}
                                  onChange={val => setRefThursdayFrom(val)}/>
                      <TimePicker format={24} start="00:00" end="23:00" step={60} value={refThursdayTo}
                                  onChange={val => setRefThursdayTo(val)}/>
                    </Form.Group>
                  </Col>
                  <Col md={3}>
                    <Form.Group className="mb-3" controlId="formBasicFirstName">
                      <Form.Label>{t('friday')}</Form.Label>
                      <TimePicker format={24} start="00:00" end="23:00" step={60} value={refFridayFrom}
                                  onChange={val => setRefFridayFrom(val)}/>
                      <TimePicker format={24} start="00:00" end="23:00" step={60} value={refFridayTo}
                                  onChange={val => setRefFridayTo(val)}/>
                    </Form.Group>
                  </Col>
                  <Col md={3}>
                    <Form.Group className="mb-3" controlId="formBasicFirstName">
                      <Form.Label>{t('saturday')}</Form.Label>
                      <TimePicker format={24} start="00:00" end="23:00" step={60} value={refSaturdayFrom}
                                  onChange={val => setRefSaturdayFrom(val)}/>
                      <TimePicker format={24} start="00:00" end="23:00" step={60} value={refSaturdayTo}
                                  onChange={val => setRefSaturdayTo(val)}/>
                    </Form.Group>
                  </Col>
                </Row>
                {/*<Button className="my-3" type="submit"> {t('confirm')} </Button>*/}
                <BigOrangeBtn classname={s.confirmBtn} type="submit"> {t('confirm')} </BigOrangeBtn>
              </Form>
