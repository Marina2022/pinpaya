                ...
                { !isMobile && !isTablet &&
                    <Col lg="3">
                        <div className="border p-4 bg-white user-left-menu">
                            ...
                            <div className="m-2"><Link to="my-wallet"><img src="/smenu3.svg" />{t('my_wallet')}</Link></div>
                            <div className="m-2"><Link to="payment-methods"><img src="/smenu4.svg" />{t('payment_methods')}</Link> </div>
