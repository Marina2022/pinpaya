        ...
        <Row className="my-5">
          <Col lg={8}>
            {
              tutor.video_url &&
              <Col lg={12}>
                <iframe src={tutor.video_url} style={{width: '100%', marginBottom: '15px', height: '400px'}}
                ...
                <Col lg={9}>
                  <div className="mb-2">
                    ...
                    <div className="mt-4" style={{display: 'flex'}}>
                      <span style={{width: '250px', flexShrink: '0'}}
                            className="fw-bold tutor-page-desc">{t('teaches')}: </span>
                      <div>
                    ...
                    <div style={{display: 'flex'}}>
                      <div style={{width: '250px', flexShrink: '0'}}
                           className="fw-bold tutor-page-desc">{t('experience')}:
                      </div>
                      <div>{tutor.experience}</div>
                    </div>
                    <div className="mb-2" style={{display: 'flex'}}>
                      <div style={{width: '250px', flexShrink: '0'}}
                           className="fw-bold mb-2 tutor-page-desc">{t('speaks')}:
                      </div>
                      <div>
                        ...
                        certificates.map(item =>
                          <div className="border m-2">
                            <a target="_blank" href={`https://web.pinpaya.com/storage/${item.images}`}><img
                              style={{width: '150px', height: '150px', objectFit: 'cover'}} className="img-fluid mx-2"
                              key={item.id} src={'https://web.pinpaya.com/storage/' + item.images} width="150" alt=""/></a>
                          </div>
                        )}
                ...
                <Col md={12}>
                  <div className="p-4">
                    ...
                    <div className="mt-4">
                      ...
                      />
                      <div>
                        <button disabled={selected.length > 0 && tutor.status == 1 ? false : true}
                                className="btn btn-lg border my-3"
                                onClick={bookLessons}>{tutor.status == 0 ? '-' : t('schedule_lessons')}</button>
                      </div>
                    </div>
                  </div>
                </Col>
          ...
          <Col lg={4}>
            <div className="p-5 border bg-white">
              <h4 className="text-center"><span className="pr-4">{t('average_rating')}</span> <img src="/star12gold.svg"
                                                                                                   style={{
                                                                                                     width: '24px',
                                                                                                     marginRight: '10px'
                                                                                                   }} alt=""/> - </h4>
        ...
        <Form onSubmit={onSubmitCheckout}>
          ...
          <Modal.Body>
            <div>
              ...
              <div className="mb-4 text-center fw-bold">{selected.length > 0 ? selected.length : 1} lesson
              ...
              <div className="my-4">
                <div className="d-flex justify-content-between">
                  ...
                  <div className="fz-15">
                    ...
                    <div>1.00 €</div>
                    <div
                      className="mt-2 fz-18 fw-bold">{selected.length > 0 ? tutor.price * selected.length + 1 : tutor.price + 1} €
                    </div>
                  </div>
                </div>
              </div>
              ...
              <Row>
                <Col md={10}>
                  <Form.Group className="mb-3" controlId="13">
                    <Form.Label className="fw-bold">{t('you_have')} <Badge style={{color: 'black'}}
                                                                           bg="warning">{user?.wallet} €</Badge> {t('in_your_wallet')}
                    </Form.Label>
                ...
                <Col md={2} className="align-items-center d-flex"><Button
                  className="btn btn-sm">{t('use')}</Button></Col>
              </Row>
            </div>
            <div className="p-2 mb-4 mt-1" style={{background: '#dfdcde'}}>
              ...
              <div className="custom-control custom-checkbox d-flex justify-content-around">
                <input type="checkbox" className="custom-control-input" style={{marginRight: '10px'}}
                       id="same-address1"/>
                <label className="custom-control-label text-dark"
                       htmlFor="same-address1"><b>{t('card_info_1')}</b></label>
              </div>
            </div>
            <div className="custom-control custom-checkbox d-flex justify-content-around">
